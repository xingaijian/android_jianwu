...
public class ChatActivity extends RockActivity {
    ...
    private int showmaxid	= 0,issendyy=0,ishistory=0,showminid	= 999999999,what_sendcont = 3001,what_upfile = 3002,sendnnid = -1,what_scrooto=4001,what_autoclose=4002,what_scrllo=4003;
    ...
    private int addchatlist(Map<String, String> a, int lx, String stype)
    {
        ...
        if(!Rock.equals(fileid,"0")) {
            frs = Sqlite.getone(SqliteClass.tn_file,"`id`="+fileid+"", "`id`,`fileext`,`filename`,`filepath`,`thumbpath`,`filesizecn`,`downpath`");
            if(frs!=null){
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo)
    {
        ...
        menu.add(0, 0, Menu.NONE, Rock.getstring(this,"copy"));
        menu.add(0, 1, Menu.NONE, Rock.getstring(this,"ziliaov"));
    }
    ...
    private void showaddmenu()
    {
        ...
        menu.add(0,1,0,"发文件");
       // menu.add(0,2,0,"定位");
       // menu.add(0,3,0,issendyy==0 ? "发语音" : "发文字");
    ...
    private void sendfileok(String bstr)
    {
        ...
        Sqlite.update(SqliteClass.tn_file,"`downpath`='"+cappath+"'", "`id`="+b.get("id")+"");
        String conss = "";
    ...
    private void yybtnonTouch(MotionEvent event)
    {
